...
def test_tsdf_mesh_map_builder_integrates_keyframes_and_decimates_mesh() -> None:
    ...
    assert update.mesh_geometry_revision == 1
    assert update.mesh_color_revision == 1
...
def test_tsdf_mesh_map_builder_recolors_vertices_from_segmentation_observation() -> None:
    ...
    assert builder.current_mesh_revision() == 1
    assert builder.current_mesh_geometry_revision() == 1
    assert builder.current_mesh_color_revision() == 2
